...
%\graphicspath{ {/Users/kimk13/Dropbox/Wharton/Research/Labor/gph/JMP/} }
...
%}
%This chapter takes a first step in filling this gap by examining the causal effect of discontinuity of post-acute care caused by provider switches on hospital readmissions using a novel data set from a large multi-state freestanding home health agency.
...
Third, repeated visits enhance the development of patient-specific knowledge, which has limited applicability to other patients.
Therefore, patients experiencing a handoff lose access to providers most familiar with their case. For example, previous literature emphasizes the development of firm- or patient-specific skills among cardiac surgeons and radiologists, which are associated with a reduction in patient mortality rates \citep{Huckman2006}.
...
%\newpage
%\graphicspath{ {/Users/kimk13/Dropbox/Wharton/Research/Labor/gph/anhandoff/new/} }
%\begin{figure}[H]
%\begin{minipage}{\linewidth}
%\centering
%\subcaptionbox{Charlson comorbidity score\label{fig:charls_byday2abs}}{\includegraphics[width=0.5\linewidth, keepaspectratio]{charls_byday2abs}}
...
%\begin{table}[H]
%\centering
%\caption{Summary statistics of instruments}
%\label{tab:summstats_instr}
%\begin{tabular}{lccc} \hline
% & (1) & (2) & (3) \\
%VARIABLES & N & mean & sd \\ \hline
% &  &  &  \\
%worked & 1.086e+06 & 0.648 & 0.477 \\
%worked\_oo & 1.086e+06 & 0.0123 & 0.110 \\
%vacation & 1.086e+06 & 0.0319 & 0.176 \\
%absent\_short & 1.086e+06 & 0.281 & 0.449 \\
%absent\_long & 1.086e+06 & 0.0158 & 0.125 \\
%nomorework & 1.086e+06 & 0.0110 & 0.104 \\
% &  &  &  \\ \hline
%\end{tabular}
%\end{table}
...
%\caption{Absenteeism rate and the mean number of working days between inactivity by the average patients' severity and by the monthly workload}
%\label{tab:iv_exog}
%\begin{threeparttable}
%{
%\begin{tabular}{l c c c c c}
%\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
%\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}*{5}{c}} %{lcccc}
%\toprule
%& & \multicolumn{4}{c}{Monthly number of visits}\\
% &  &  Low & High & Low & High \\
%& & (1) & (2) & (3) & (4) \\
%\midrule
%& & \multicolumn{2}{c}{A. Percent of absent days} &  \multicolumn{2}{c}{B. Mean number of days between absences}\\
%\cmidrule(lr){3-4} \cmidrule(lr){5-6}
%
%\multirow{2}[3]{*}{\parbox{5cm}{(i) Mean Charlson comorbidity score}}
%& Low  & 0.46 & 0.41  & 4.32  & 4.38  \\
%& High & 0.50 & 0.47  & 4.20 & 4.45 \\
%\midrule
%\multirow{2}[3]{*}{\parbox{5cm}{(ii) Fraction of patients with a ``likely to remain fragile'' status}}
%& Low  & 0.45 & 0.40  & 4.58  & 4.38  \\
%& High & 0.50 & 0.47  & 4.10 & 4.45 \\
%\midrule
%\multirow{2}[3]{*}{\parbox{5cm}{(iii) Fraction of patients taking 5 or more medications}} & Low  & 0.44 & 0.39  & 4.60  & 4.40  \\
%& High & 0.50  & 0.47 &4.14 & 4.44\\
%\bottomrule
%\end{tabular}
%}
%	\begin{tablenotes}[para,flushleft]
%	\footnotesize
%	\item \emph{Notes.} The unit of observation is a nurse-month. A low (high) category refers to months with low (high) values that are below (above) median of the corresponding variable across all months for each nurse.
%	The sample used for this figure includes all patients who receive home health care---such as those aged less than 65, enrolled in non-Medicare plans, or having more than one 60-day episode during the home health care---all of whom we exclude in our sample restriction for the regression analysis.
%	%The inactivity in Panel B refers to absence excluding attrition.
%	\end{tablenotes}
%\end{threeparttable}
%\end{table}
...
% \setlength\tabcolsep{0pt}
% \centering
% \caption{GMM 2SLS: Effect of Handoffs on Rehospitalization among Relatively Low-Risk Patients Whose Overall Status Was Temporarily Facing High Health Risks}
% \label{tab:iv_tempbad}
% \begin{threeparttable}
% {
% \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
% \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}*{4}{c}} %{lcccc}
...
% \midrule
% \multicolumn{5}{l}{A. First stage - Handoff} \\
% Short absence       &      0.1364***&      0.1363***&      0.1362***&      0.1361***\\
%                     &    (0.0066)   &    (0.0067)   &    (0.0066)   &    (0.0066)   \\
% Medium absence      &      0.4138***&      0.4138***&      0.4131***&      0.4127***\\
%                     &    (0.0118)   &    (0.0118)   &    (0.0118)   &    (0.0118)   \\
% Long absence        &      0.5321***&      0.5320***&      0.5307***&      0.5301***\\
%                     &    (0.0131)   &    (0.0132)   &    (0.0133)   &    (0.0134)   \\
% Other office        &      0.3218***&      0.3217***&      0.3212***&      0.3209***\\
%                     &    (0.0217)   &    (0.0218)   &    (0.0217)   &    (0.0217)   \\
% Attrition           &      0.4752***&      0.4752***&      0.4758***&      0.4762***\\
%                     &    (0.0191)   &    (0.0191)   &    (0.0191)   &    (0.0190)   \\
% R-squared           &       0.177   &       0.177   &       0.177   &       0.178   \\
% F-statistic         &     507.416   &     505.388   &     503.431   &     497.345   \\
% \\
% \multicolumn{5}{l}{B. First stage - Have a nurse visit} \\
% Short absence       &     -0.1111***&     -0.1111***&     -0.1111***&     -0.1111***\\
%                     &    (0.0049)   &    (0.0049)   &    (0.0049)   &    (0.0050)   \\
% Medium absence      &     -0.0964***&     -0.0963***&     -0.0963***&     -0.0963***\\
%                     &    (0.0036)   &    (0.0036)   &    (0.0036)   &    (0.0036)   \\
% Long absence        &     -0.0943***&     -0.0944***&     -0.0945***&     -0.0945***\\
%                     &    (0.0056)   &    (0.0056)   &    (0.0055)   &    (0.0055)   \\
% Other office        &     -0.1320***&     -0.1320***&     -0.1318***&     -0.1319***\\
%                     &    (0.0072)   &    (0.0072)   &    (0.0072)   &    (0.0072)   \\
% Attrition           &     -0.0846***&     -0.0843***&     -0.0842***&     -0.0837***\\
%                     &    (0.0051)   &    (0.0051)   &    (0.0052)   &    (0.0052)   \\
% R-squared           &       0.247   &       0.247   &       0.247   &       0.247   \\
% F-statistic         &     166.564   &     165.883   &     164.082   &     163.003   \\
% \\
% \multicolumn{5}{l}{C. Second stage - Rehospitalization} \\
% Handoff             &      0.0031***&      0.0032***&      0.0034***&      0.0034***\\
%                     &    (0.0011)   &    (0.0011)   &    (0.0011)   &    (0.0010)   \\
% Have a nurse visit  &      0.0036   &      0.0037   &      0.0039   &      0.0039   \\
%                     &    (0.0025)   &    (0.0025)   &    (0.0025)   &    (0.0024)   \\
% R-squared           &       0.004   &       0.004   &       0.004   &       0.004   \\
% J-statistic p-value &       0.532   &       0.515   &       0.510   &       0.531   \\
% \\
% \midrule
% Observations        &      625687   &      625687   &      625687   &      625687   \\
% Hospitalization risk controls & . & Yes & Yes & Yes \\
% Demographic controls & . & . & Yes & Yes \\
%  Comorbidity controls & . & . & . & Yes \\
% \bottomrule
...
% \setlength\tabcolsep{0pt}
% \centering
% \caption{GMM 2SLS: Effect of Handoffs on Rehospitalization among High-Risk Patients Whose Overall Status Was Likely to Remain in Fragile Health}
% \label{tab:iv_fragile}
% \begin{threeparttable}
% {
% \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
% \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}*{4}{c}} %{lcccc}
...
% \midrule
% \multicolumn{5}{l}{A. First stage - Handoff} \\
% Short absence       &      0.1250***&      0.1250***&      0.1248***&      0.1248***\\
%                     &    (0.0078)   &    (0.0078)   &    (0.0078)   &    (0.0078)   \\
% Medium absence      &      0.4074***&      0.4072***&      0.4071***&      0.4071***\\
%                     &    (0.0130)   &    (0.0131)   &    (0.0131)   &    (0.0131)   \\
% Long absence        &      0.5072***&      0.5074***&      0.5069***&      0.5066***\\
%                     &    (0.0196)   &    (0.0196)   &    (0.0197)   &    (0.0193)   \\
% Other office        &      0.2644***&      0.2640***&      0.2630***&      0.2625***\\
%                     &    (0.0269)   &    (0.0268)   &    (0.0266)   &    (0.0265)   \\
% Attrition           &      0.4431***&      0.4435***&      0.4436***&      0.4433***\\
%                     &    (0.0276)   &    (0.0277)   &    (0.0277)   &    (0.0282)   \\
% R-squared           &       0.176   &       0.176   &       0.177   &       0.179   \\
% F-statistic         &     309.237   &     310.090   &     311.057   &     311.131   \\
% \\
% \multicolumn{5}{l}{B. First stage - Have a nurse visit} \\
% Short absence       &     -0.1068***&     -0.1068***&     -0.1069***&     -0.1068***\\
%                     &    (0.0054)   &    (0.0054)   &    (0.0054)   &    (0.0054)   \\
% Medium absence      &     -0.0964***&     -0.0966***&     -0.0967***&     -0.0966***\\
%                     &    (0.0044)   &    (0.0045)   &    (0.0045)   &    (0.0045)   \\
% Long absence        &     -0.0892***&     -0.0892***&     -0.0893***&     -0.0891***\\
%                     &    (0.0058)   &    (0.0059)   &    (0.0058)   &    (0.0057)   \\
% Other office        &     -0.1313***&     -0.1315***&     -0.1310***&     -0.1310***\\
%                     &    (0.0102)   &    (0.0101)   &    (0.0100)   &    (0.0100)   \\
% Attrition           &     -0.0705***&     -0.0703***&     -0.0706***&     -0.0701***\\
%                     &    (0.0072)   &    (0.0073)   &    (0.0074)   &    (0.0073)   \\
% R-squared           &       0.240   &       0.240   &       0.241   &       0.241   \\
% F-statistic         &     171.856   &     170.450   &     174.551   &     173.479   \\
% \\
% \multicolumn{5}{l}{C. Second stage - Rehospitalization} \\
% Handoff             &      0.0052*  &      0.0052*  &      0.0053*  &      0.0053*  \\
%                     &    (0.0028)   &    (0.0029)   &    (0.0029)   &    (0.0029)   \\
% Have a nurse visit  &      0.0039   &      0.0040   &      0.0040   &      0.0041   \\
%                     &    (0.0063)   &    (0.0063)   &    (0.0063)   &    (0.0063)   \\
% R-squared           &       0.006   &       0.007   &       0.007   &       0.007   \\
% J-statistic p-value &       0.837   &       0.778   &       0.730   &       0.751   \\
% \\
% \midrule
% Observations        &      300077   &      300077   &      300077   &      300077   \\
% Hospitalization risk controls & . & Yes & Yes & Yes \\
% Demographic controls & . & . & Yes & Yes \\
%  Comorbidity controls & . & . & . & Yes \\
% \bottomrule
...
% \setlength\tabcolsep{0pt}
% \centering
% \caption{OLS: Patients Experiencing a Handoff Are Rehospitalized More Quickly}
% \label{tab:days2readmit_ols}
% \begin{threeparttable}
% \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}*{4}{c}} %{lcccc}
% \toprule
% & \multicolumn{4}{c}{Dep Var: Ln(Number of days to readmission since last nurse visit)} \\
%  & (1) & (2) & (3) & (4) \\
% \midrule
% Handoff & -0.0803*** & -0.0796*** & -0.0781*** & -0.0810*** \\
%  & (0.0194) & (0.0195) & (0.0194) & (0.0194) \\
% R-squared & 0.4090 & 0.4100 & 0.4134 & 0.4167 \\
% Observations & 7,269 & 7,269 & 7,269 & 7,269 \\
% % Mean dep. var. & 1.1843 & 1.1843 & 1.1843 & 1.1843 \\
% % \% change in rehosp from HO & -6.78 & -6.72 & -6.59 & -6.84 \\
% Hospitalization risk controls & . & Yes & Yes & Yes \\
% Demographic controls & . & . & Yes & Yes \\
% Comorbidity controls & . & . & . & Yes \\
% \bottomrule
...
% 	\begin{tablenotes}[para,flushleft]
% 	\scriptsize
% 	\item \emph{Notes.} This table presents OLS estimation models examining whether among patients who end up being rehospitalized, experiencing a handoff in the last nurse visit shortens the time to readmission.
% 	%(A) whether patients experiencing a handoff are more likely to be rehospitalized; (B) whether the effect on the probability of rehospitalization differs by the frequency of handoff; and (C) whether patients experiencing a handoff from salaried to piece-rate workers are more likely to be rehospitalized.
% 	An observation is a patient episode. Standard errors are clustered at the home health office level, allowing for arbitrary correlation among episode in the same office in parentheses.
% 	In all panels and all columns, we control for cumulative number of nurse visits provided, mean interval of days between two consecutive visits during the episode, number of days since last nurse visit, number of days since last visit by any provider; number of ongoing episodes in the office-day, number of nurses working in the office-day; and office fixed effects, day of week fixed effects, month-year of the day fixed effects, and home health day fixed effects. The day level data refer to the day of last nurse visit.
% 	In columns (2)-(4), hospitalization risk controls include dummies for the risk factors for hospitalization: history of 2+ falls in the past 12 months; 2+ hospitalizations in the past 6 months; decline in mental, emotional, or behavioral status in the past 3 months, currently taking 5+ medications, and others.
% 	In columns (3)-(4), demographic controls include age dummies for each age 66-94 and age 95+ (reference group: age=65); female; white; insurance type--Medicare Advantage (MA) plan with a visit-based reimbursement, MA plan with an episode-based reimbursement, dual eligible with Medicaid enrollment (reference group: Medicare FFS); dummy for having no assistance available; dummy for living alone.
% 	In column (4), comorbidity controls include dummies for 17 Charlson comorbidity index factors; dummies overall status--very bad (patient has serious progressive conditions that could lead to death within a year), bad (patient is likely to remain in fragile health); and temporarily bad (temporary facing high health risks); dummies for high-risk factors--alcohol dependency, drug dependency, smoking, obesity--and dummies for conditions prior to hospital stay within past 14 days--disruptive or socially inappropriate behavior, impaired decision making, indwelling or suprapublic catheter, intractable pain, serious memory loss, urinary incontinence.
% 	 *significant at 10\%; **significant at 5\%; ***significant at 1\%.
